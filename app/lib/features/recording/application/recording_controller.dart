...
if (route.personalBest case final pb?) {
      // Ghost = the PB attempt walking the route at PB speed. Only the fake
      // engine can *generate* a recording; M9 will source ghosts from storage.
      final engine = ref.read(engineServiceProvider) as FakeEngineService;
